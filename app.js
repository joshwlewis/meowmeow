...
config = {
  apiHost: 'http://beenz.joshwlewis.com',
  clientHost: 'http://meowmeow.joshwlewis.com'
};
...
ProfileFormView = FormView.extend({
...
SessionFormView = FormView.extend({
  template: 'session_form',
  className: 'session-form-view'
});
